...
class Ui_Gragh_show(object):
    def setupUi(self, Gragh_show):
        ...
        self.Posx_spinBox = QSpinBox(self.groupBox_3)
        self.Posx_spinBox.setObjectName(u"Posx_spinBox")
        self.Posx_spinBox.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.Posx_spinBox.setMinimum(1)
        self.Posx_spinBox.setMaximum(65535)
        self.Posx_spinBox.setValue(1)
        self.Posx_spinBox.setDisplayIntegerBase(10)

        self.horizontalLayout_10.addWidget(self.Posx_spinBox)
        ...
        self.Posy_spinBox = QSpinBox(self.groupBox_3)
        self.Posy_spinBox.setObjectName(u"Posy_spinBox")
        self.Posy_spinBox.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.Posy_spinBox.setMinimum(1)
        self.Posy_spinBox.setMaximum(65535)
        self.Posy_spinBox.setValue(1)
        self.Posy_spinBox.setDisplayIntegerBase(10)

        self.horizontalLayout_10.addWidget(self.Posy_spinBox)
        ...
        self.Posz_spinBox = QSpinBox(self.groupBox_3)
        self.Posz_spinBox.setObjectName(u"Posz_spinBox")
        self.Posz_spinBox.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.Posz_spinBox.setMinimum(1)
        self.Posz_spinBox.setMaximum(65535)
        self.Posz_spinBox.setValue(1)
        self.Posz_spinBox.setDisplayIntegerBase(10)

        self.horizontalLayout_10.addWidget(self.Posz_spinBox)

        self.Setpos_Button = QToolButton(self.groupBox_3)
        self.Setpos_Button.setObjectName(u"Setpos_Button")

        self.horizontalLayout_10.addWidget(self.Setpos_Button)
        ...
        self.Getpos_lineEdit = QLineEdit(self.groupBox_3)
        self.Getpos_lineEdit.setObjectName(u"Getpos_lineEdit")

        self.horizontalLayout_11.addWidget(self.Getpos_lineEdit)

        self.Getpos_Button = QToolButton(self.groupBox_3)
        self.Getpos_Button.setObjectName(u"Getpos_Button")

        self.horizontalLayout_11.addWidget(self.Getpos_Button)

        self.Stra_Button = QToolButton(self.groupBox_3)
        self.Stra_Button.setObjectName(u"Stra_Button")

        self.horizontalLayout_11.addWidget(self.Stra_Button)

        self.Startpos_Button = QToolButton(self.groupBox_3)
        self.Startpos_Button.setObjectName(u"Startpos_Button")

        self.horizontalLayout_11.addWidget(self.Startpos_Button)
    ...
    def retranslateUi(self, Gragh_show):
        ...
        self.label_11.setText(QCoreApplication.translate("Gragh_show", u"\u5750\u6807x:", None))
        self.label_13.setText(QCoreApplication.translate("Gragh_show", u"y", None))
        self.label_14.setText(QCoreApplication.translate("Gragh_show", u"z", None))
        self.Setpos_Button.setText(QCoreApplication.translate("Gragh_show", u"\u8bbe\u7f6e", None))
        self.Getpos_Button.setText(QCoreApplication.translate("Gragh_show", u"\u83b7\u53d6\u5750\u6807", None))
        self.Stra_Button.setText(QCoreApplication.translate("Gragh_show", u"\u6821\u51c6", None))
        self.Startpos_Button.setText(QCoreApplication.translate("Gragh_show", u"\u521d\u59cb\u5316", None))
