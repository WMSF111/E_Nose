...
if __name__ == "__main__":
    DataFrame = (transfo.UI_TXT_TO.read_files_to_dataframe
                 (".\\pca2.xlsx"))  # 读取txt转数组
    ...
    print(iris_dataset[0], iris_dataset[1])
    x_train, x_test, y_train, y_test = split_data_set(data, target)
