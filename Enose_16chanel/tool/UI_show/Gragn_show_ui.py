...
class Action():
    ...
    def _attendtime_spinBox(self, time: int):
        ...
        self.ui.opea = SO.time_thread(self.ui.ser, self.ui.ser1, starttime=time)  # 创建time线程对象
        self.ui.opea.thread_loopfun(self.ui.SO1.push_opea)  # 循环直到达到指定温度
...
class GraphShowWindow(QWidget, Ui_Gragh_show):
    ...
    def initMS(self):
        ...
        self.ms._auto_save.connect(self.a._auto_save)
